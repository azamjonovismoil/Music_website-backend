...
router.get('/public', async (req, res) => {
  ...
  try {
    ...
    const tracks = await Music.find(filter)
    ...
    const docs = tracks.map((t) => buildDoc(t, null))

    const payload = docs.map((track) => ({
      ...
      highlightText: track.highlightText,
    ...
    console.error('[Music GET /public]', err)
